  ...
  return (
    <OriginalInfoPage
      ...
      cards={[
        {
          title: "Cart review",
          text: "Check products, quantities, prices and fit-out notes before submitting the order.",
        },
        {
          title: "Dealer confirmation",
          text: "Large products such as boats, motors and trailers need stock and delivery confirmation.",
        },
        {
          title: "Secure handover",
          text: "The final payment and handover path is coordinated with Axiom Marine sales.",
        },
      ]}
    />
  );
