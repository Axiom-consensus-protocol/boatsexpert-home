...
const BOATS = [
    liveBoat({ brand: 'Atlas RIB', cat: 'RIB Boats', country: 'ua', model: 'VIKING V6F (V580F)', price: '€26,366', length: '5.8 m', persons: '12', power: '150 HP', photo: 'assets/boats/gala-viking-v6f-111-654x525.jpg' }),
    ...
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'HEAVY DUTY HC520', price: 'Request', length: '5.20 m', persons: '5', power: '8 hp', photo: 'assets/boats/galaxy-heavy-duty-hc520-654x525.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'HEAVY DUTY HD460M', price: 'Request', length: '4.70 m', persons: '10', power: '50 hp', photo: 'assets/boats/galaxy-heavy-duty-hd460m-654x525.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'HEAVY DUTY F450HD', price: 'Request', length: '4.50 m', persons: '6', power: '50 hp', photo: 'assets/boats/galaxy-hd460m.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'HEAVY DUTY P4.6HD', price: 'Request', length: '4.57 m', persons: '7', power: '60 hp', photo: 'assets/boats/galaxy-heavy-duty-hd460m-654x525.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P6.5', price: '€26,330', length: '6.50 m', persons: '12', power: '200 hp', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P4', price: '€7,920', length: '3.90 m', persons: '6', power: '30 hp', photo: 'assets/boats/galaxy-pilot-p4-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'TRIDENT - T12', price: '€178,940', length: '11.60 m', persons: '20', power: '1200 hp', photo: 'assets/boats/galaxy-trident-t12-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'TRIDENT - T10', price: '€149,510', length: '9.60 m', persons: '16', power: '700 hp', photo: 'assets/boats/galaxy-trident-t12-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'TRIDENT - T6.5', price: '€70,650', length: '6.50 m', persons: '10', power: '300 hp', photo: 'assets/boats/galaxy-trident-t12-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P4.5', price: '€12,760', length: '4.50 m', persons: '7', power: '70 hp', photo: 'assets/boats/galaxy-pilot-p4-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P5', price: '€15,970', length: '5.00 m', persons: '8', power: '100 hp', photo: 'assets/boats/galaxy-pilot-p4-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P6', price: '€23,100', length: '5.80 m', persons: '10', power: '175 hp', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'PILOT - P7', price: '€32,560', length: '6.95 m', persons: '13', power: '300 hp', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'TRIDENT T8', price: '€101,010', length: '7.80 m', persons: '14', power: '500 hp', photo: 'assets/boats/galaxy-trident-t12-654x525.jpg' }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'Pilot - P12', price: 'Request', length: '11.60 m', persons: '18', power: '900 hp', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'Pilot - P10', price: 'Request', length: '9.60 m', persons: '16', power: '700 hp', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg', request: true }),
    liveBoat({ brand: 'Atlas RIBXY', cat: 'Aluminium Boats', country: 'ua', model: 'Pilot - P8', price: '€44,040', length: '7.80 m', persons: '14', power: '350 HP', photo: 'assets/boats/galaxy-pilot-p6-5-654x525.jpg' }),
  ];
