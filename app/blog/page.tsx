...
export const metadata: Metadata = {
  ...
  description: "Original Axiom Marine blog archive: RIB news, Garmin promotions, boat shows and Demo posts.",
...
export default function BlogPage() {
  return (
    <OriginalInfoPage
      ...
      lead="The original site includes a blog archive with RIB articles, boat-show news, Garmin and FurSeal promotions, plus Demo versions. This page restores that information as a proper route in the new site."
