...
export const metadata: Metadata = {
  title: "Checkout | BoatsExpert",
  description: "Original checkout entry point mapped into the new BoatsExpert site.",
...
export default function CheckoutPage() {
  return (
    <OriginalInfoPage
      ...
      source="https://boatsexpert.com/checkout/"
      cards={[
        ...
        { title: "Secure handover", text: "The final payment and handover path is coordinated with BoatsExpert sales." },
      ]}
    />
  );
}
